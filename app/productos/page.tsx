...
export default async function ProductosPage({ searchParams }: ProductosPageProps) {
    ...
    return (
        <div className="">
            ...
            <div className="lg:hidden p-4 border-b bg-gray-50 flex gap-2">
                <div className="flex-1">
                    <Suspense fallback={<div className="w-full h-10 bg-gray-200 rounded-md animate-pulse" />}>
                        <SearchCommand rubros={rubros} />
                    </Suspense>
                </div>
                <ProductFiltersSheet rubros={rubros} miscellaneousCategories={miscellaneousCategories} />
            </div>

            <div className="container mx-auto py-8 px-4">
                {/* Desktop: Search bar + Filters button */}
