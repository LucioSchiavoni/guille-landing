            ...
            <div className="grid md:grid-cols-2 min-h-0 sm:min-h-[450px]">
                ...
                <div className="flex flex-col justify-center p-4 sm:p-8 md:p-12 bg-white">
                    <div className="space-y-3 sm:space-y-6">
                        <div>
                            <h1 className="text-xl sm:text-2xl md:text-4xl font-bold text-gray-900 leading-tight mb-2 sm:mb-3">
                                {product.name}
                            </h1>
                        ...
                        <div className="pt-4 sm:pt-6 border-t border-gray-100 mt-auto">
                            <motion.button
                                ...
                                className="w-full flex items-center justify-center gap-2 bg-emerald-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base hover:bg-emerald-800 transition-all shadow-xl shadow-emerald-700/20"
                            >
