    ...
    return (
        <main className="flex-1 flex flex-col lg:flex-row items-start lg:items-center justify-center py-6 lg:py-12 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                ...
                <motion.div
                    className="hidden lg:flex flex-col justify-center space-y-8 pr-12 border-r border-border/30"
                    initial="hidden"
                    animate="visible"
                ...
                >
                    <motion.div variants={itemVariants}>
                        <motion.h1
                            className="text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/50 mb-4"
